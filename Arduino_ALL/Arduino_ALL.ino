...
byte Card1[4]= {0x3E, 0xB5, 0xBB, 0x32} ; // Tempo 1 Card 1  
byte Card2[4]= {0xD2, 0x5B, 0xD4, 0x4C} ; // Tempo 2 Card 2 
byte Card3[4]= {0xFE, 0xBD, 0x34, 0xF8} ; // Tempo 3 Card 3
byte Card4[4]= {0x44, 0xF0, 0x54, 0xFA} ; // Ritmo 1 Card 4
byte Card5[4]= {0x32, 0x9C, 0x96, 0x3F} ; // Ritmo 2 Card 5
byte Card6[4]= {0x9F, 0x54, 0x84, 0x2C} ; // Ritmo 3 Card 6
byte Card7[4]= {0xEF, 0x49, 0x8A, 0x5B} ; // Melodia 1 Card 7 
byte Card8[4]= {0x29, 0xBA, 0x60, 0x41} ; // Melodia 2 card 8
byte Card9[4]= {0xFA, 0xD4, 0xBC, 0x12} ; // Melodia 3 Card 9
